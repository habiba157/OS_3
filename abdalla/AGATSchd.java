...
public class AGATSchd {
    ...
    public ArrayList<Process> secondProcesses = new ArrayList<Process>();
    ...
    public Process getMinimumAGATFactor(int time){
        double minAGAT = Double.MAX_VALUE ;///
        int indx = 0 , i = 0;
    ...
    /////////////////////////////////////////////
     public int calculateAvgQuantum() {
        double sum = 0.0;
        int numberOfProcesses = 0;
        for (Process p : processes)
        {
            sum += p.getQuantumTime();
            if(p.getQuantumTime() != 0)
                numberOfProcesses++;
        }
        return (int) Math.ceil((sum/numberOfProcesses) * 0.1);
    }
     /////////////////////////////////////////////
     /*public void printResults() {
        ...
        for(Process p: secondProcesses){
            totalTurnaroundTime += p.getTurnaroundTime();
            totalWaitingTime += p.getWaitingTime();
        }

        //System.out.println("AVG - Turnaround Time: " + (double) totalTurnaroundTime/secondProcesses.size());
        //System.out.println("AVG - Waiting Time: " + (double) totalWaitingTime/secondProcesses.size());
    }*/
    ////////////////////////////////////////////
